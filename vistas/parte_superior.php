  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
        ...
        <div class="sidebar-brand-text mx-3">Control IoT</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="devices.php">Dispositivo</a>
            <a class="collapse-item" href="worker.php">Trabajador</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Trabajadores -->
      <li class="nav-item">
        <a class="nav-link" href="assignacc.php">
          <i class="fas fa-fw fa-briefcase"></i>
          <span>Asignar Acceso</span></a>
      </li>
      <!-- Nav Item - Control -->
      <li class="nav-item">
